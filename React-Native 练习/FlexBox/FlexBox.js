...
export class MargginBox extends Component {
	render() {
		return (
...
export class BorderBox extends Component {
	render() {
		return (
...
export class PaddingBox extends Component {
	render() {
		return (
...
export class ElementBox extends Component {
	render() {
		return (
